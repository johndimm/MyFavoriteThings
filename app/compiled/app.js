...
class Stars extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      "div",
      { className: "stars_div" },
      React.createElement("input", { type: "hidden", name: "stars", value: this.state.num }),
      dummy.map(function (key, i) {
        return React.createElement(
          "span",
          { key: i, onClick: function () {
              this.setNum(i + 1);
            }.bind(this), className: key },
          star
        );
      }.bind(this))
    );
...
class TextField extends React.Component {
  ...
  renderEdit() {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "textField", contentEditable: "true", onBlur: this.submitChange.bind(this), type: "text",
          ref: ref => this.textFieldInput = ref, onKeyDown: this.onKeyDown.bind(this),
          placeholder: this.props.name, defaultValue: this.state.value },
        this.state.value
      )
    );
  }
...
class Photo extends React.Component {
  ...
  renderReadOnly() {
    return React.createElement("img", { className: "photo_static", src: "/MyFavoriteThings/user_photos/" + this.state.photo,
  ...
  renderEdit() {
    return React.createElement(
      ...
      React.createElement(
        "label",
        null,
        React.createElement("img", { className: "photo_edit", src: "/MyFavoriteThings/user_photos/" + this.state.photo,
          ref: ref => this.previewImage = ref
        }),
        React.createElement("input", { type: "file", name: "uploaded_file", id: "uploaded_file", accept: "image/*",
          ref: ref => this.uploaded_file = ref, onChange: this.setPreviewImage.bind(this) }),
        React.createElement("input", { type: "hidden", name: "review_id", value: this.props.review_id })
      )
    );
  }
...
class Review extends React.Component {
  ...
  buttons_static() {
    return React.createElement(
      ...
      React.createElement(
        "button",
        { className: "edit_icon", onClick: this.edit_review.bind(this), title: "edit review" },
        "edit"
      ),
      React.createElement(
        "button",
        { className: "log_icon", onClick: this.log_review.bind(this) },
        "log"
      )
    );
  }
  ...
  render() {
    ...
    var button_bar = this.props.freshness == null ? React.createElement("span", null) : React.createElement(
      "div",
      { className: "button_holder", style: style },
      buttons
    );
    ...
    var styleHeight = this.props.freshness == null ? { 'height': '270px' // , 'left': x + 'px', 'top': y + 'px'}
    ...
    if (this.state.deleted) {
      ...
      return React.createElement(
        "div",
        { className: "review", style: styleHeight, draggable: true, onDragStart: e => this.onDragStart(e, this.props.log_id) },
        React.createElement(
          "button",
          { className: "delete_icon", onClick: this.delete_review.bind(this), title: "delete review" },
          "X"
        ),
        React.createElement(TextField, { review_id: this.props.review_id, value: this.props.place, editing: this.state.editing, name: "place" }),
        React.createElement(Stars, { review_id: this.props.review_id, num: this.props.stars, editing: this.props.editing }),
        React.createElement(Photo, { review_id: this.props.review_id, photo: this.props.photo, editing: this.state.editing }),
        React.createElement(TextField, { review_id: this.props.review_id, value: this.props.item, editing: this.state.editing, name: "item" }),
        button_bar,
        React.createElement(
          "div",
          { className: "stats" },
          React.createElement(
            ...
            this.format_delta(this.props.since_last)
          ),
          React.createElement(
            "div",
            { className: "last_time" },
            this.props.last_time
          ),
          React.createElement(
            "div",
            { className: "avg_delta" },
...
class Chron extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "button",
        { id: "newReviewButton", onClick: this.createNewReview.bind(this), title: "add review" },
        React.createElement(
          "span",
...
class Freshness extends React.Component {
  ...
  render() {
    ...
    var reviews = this.state.reviews.sort((a, b) => b.freshness - a.freshness).map(function (row, i) {
      ...
      return React.createElement(Review, { key: row.id,
        review_id: row.id,
        place: row.place,
        item: row.item,
        photo: row.photo,
...
class MyPage extends React.Component {
  ...
  render() {
    var reviews = this.state.layout == 'chron' ? React.createElement(Chron, { place: this.state.place, item: this.state.item }) : React.createElement(Freshness, { place: this.state.place, item: this.state.item });
...
class App extends React.Component {
  render() {
    ...
    return React.createElement(MyPage, { place: place, item: item });
  }
}
